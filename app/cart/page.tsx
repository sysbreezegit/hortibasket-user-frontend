  ...
  return (
    <main className="min-h-screen bg-[#F5F5F0] text-black font-sans selection:bg-black selection:text-white pb-20 pt-10 px-4 md:px-8 flex justify-center">
      <div className="w-full max-w-[1400px] bg-white border-2 border-black flex flex-col shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] min-h-[85vh]">
        ...
        {/* FEATURED PRODUCTS SECTION: BRUTALIST STYLE */}
        <div className="mt-16 border-t-2 border-black pt-16 mb-20 px-8 md:px-14">
          <header className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
            <div className="flex flex-col gap-2">
               <div className="bg-[#89C839] border-2 border-black px-3 py-1 font-black text-[10px] uppercase tracking-widest inline-block self-start shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                 Supplementary Sourcing
               </div>
               <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter leading-none">
                 Recommended<br />Specimens.
               </h2>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {FEATURED_PLANTS.map((plant) => (
              <FeaturedProductCard key={plant._id} product={plant} />
            ))}
          </div>
        </div>
